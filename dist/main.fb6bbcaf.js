...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _jquery.default)('.categories-links li.with-secondary').on('mouseenter', function () {
    toggleSubLinks((0, _jquery.default)(this, true));
  }).on('mouseleave', function () {
    toggleSubLinks((0, _jquery.default)(this), false);
  });

  function toggleSubLinks(el, isOpen) {
    (0, _jquery.default)('.sub-links').removeClass('opened');
    var category = el.data('category');
    (0, _jquery.default)(".sub-links[data-id=".concat(category, "]")).toggleClass('opened', isOpen);
  }

  (0, _jquery.default)('.burger-btn').on('click', function () {
    (0, _jquery.default)('.mobile-menu').addClass('opened');
  });
  (0, _jquery.default)('.mobile-menu-close').on('click', function () {
    (0, _jquery.default)('.mobile-menu').removeClass('opened');
  });
  (0, _jquery.default)('.mobile-menu__backdrop').on('click', function () {
    return (0, _jquery.default)('.mobile-menu').removeClass('opened');
  });
  (0, _jquery.default)('.mobile-menu .arrow-btn').on('click', function () {
    (0, _jquery.default)(this).toggleClass('active');
    (0, _jquery.default)(this).closest('li').toggleClass('active');
    (0, _jquery.default)(this).closest('li').find('.sub-links').slideToggle('opened');
  });
  (0, _jquery.default)('.scroll-btn').click(function (e) {
    e.preventDefault();
    (0, _jquery.default)([document.documentElement, document.body]).animate({
      scrollTop: (0, _jquery.default)((0, _jquery.default)(this).data('query')).offset().top
    }, 1000);
  });
  (0, _jquery.default)('.calc-form .next-step').click(function () {
    var id = (0, _jquery.default)(this).data('id');
    (0, _jquery.default)('.step').removeClass('active');
    (0, _jquery.default)(".step[data-id=".concat(id, "]")).addClass('active');
  });
  (0, _jquery.default)('.append-room').click(function () {
    (0, _jquery.default)('.rooms ul li').removeClass('active');
    var roomsCount = (0, _jquery.default)('.rooms li').length;
    var nextRoomNumber = roomsCount + 1;

    if (roomsCount < 4) {
      (0, _jquery.default)('.rooms ul').append("<li class=\"active\" data-id=\"room".concat(nextRoomNumber, "\">\u041A\u043E\u043C\u043D\u0430\u0442\u0430 ").concat(nextRoomNumber, " <button type=\"button\"></button></li>"));
      (0, _jquery.default)('.rooms-controls').removeClass('active');
      (0, _jquery.default)('.rooms-wrap').append("\n                <div class=\"rooms-controls active\" data-id=\"room".concat(nextRoomNumber, "\">\n              <div class=\"form-item\">\n                <label>\u041F\u043B\u043E\u0449\u0430\u0434\u044C \u043F\u043E\u043C\u0435\u0449\u0435\u043D\u0438\u044F, \u043C2</label>\n                <input name=\"square\" type=\"number\" class=\"form-control\" placeholder=\"\u041D\u0435 \u0443\u043A\u0430\u0437\u0430\u043D\u043E\">\n              </div>\n  \n              <div class=\"form-item\">\n                <label>\u0422\u0438\u043F \u043F\u043E\u043C\u0435\u0449\u0435\u043D\u0438\u044F</label>\n  \n                <select name=\"room-type\" class=\"select form-control\">\n                  <option>\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0442\u0438\u043F</option>\n                  <option value=\"\u0421\u043F\u0430\u043B\u044C\u043D\u044F\">\u0421\u043F\u0430\u043B\u044C\u043D\u044F</option>\n                  <option value=\"\u0413\u043E\u0441\u0442\u0438\u043D\u043D\u0430\u044F\">\u0413\u043E\u0441\u0442\u0438\u043D\u043D\u0430\u044F</option>\n                  <option value=\"\u041A\u0443\u0445\u043D\u044F\">\u041A\u0443\u0445\u043D\u044F</option>\n                  <option value=\"\u0414\u0435\u0442\u0441\u043A\u0430\u044F\">\u0414\u0435\u0442\u0441\u043A\u0430\u044F</option>\n                </select>\n              </div>\n  \n              <div class=\"two-controls\">\n                <div class=\"form-item\">\n                  <label>\u0421\u0442\u043E\u0440\u043E\u043D\u0430 \u0434\u043E\u043C\u0430</label>\n  \n                  <select name=\"house-side\" class=\"select form-control\">\n                    <option>\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0442\u0438\u043F</option>\n                    <option value=\"\u0422\u0435\u043D\u0435\u0432\u0430\u044F\">\u0422\u0435\u043D\u0435\u0432\u0430\u044F</option>\n                    <option value=\"\u0421\u043E\u043B\u043D\u0435\u0447\u043D\u0430\u044F\">\u0421\u043E\u043B\u043D\u0435\u0447\u043D\u0430\u044F</option>\n                  </select>\n                </div>\n  \n                <div class=\"form-item\">\n                  <label>\u041E\u043A\u043D\u0430</label>\n  \n                  <select name=\"windows\" class=\"select form-control\">\n                    <option>\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0442\u0438\u043F</option>\n                    <option value=\"\u0421\u0442\u0430\u043D\u0434\u0430\u0440\u0442\u043D\u044B\u0435\">\u0421\u0442\u0430\u043D\u0434\u0430\u0440\u0442\u043D\u044B\u0435</option>\n                    <option value=\"\u041F\u0430\u043D\u043E\u0440\u0430\u043C\u043D\u044B\u0435\">\u041F\u0430\u043D\u043E\u0440\u0430\u043C\u043D\u044B\u0435</option>\n                  </select>\n                </div>\n              </div>\n            </div>\n            "));
      (0, _jquery.default)('.rooms ul li').click(activateRoomControls);
      (0, _jquery.default)('.rooms ul li button').click(removeRoom);
    }
  ...
  function removeRoom() {
    if ((0, _jquery.default)('.rooms ul li').length > 1) {
      (0, _jquery.default)(this).closest('li').remove();
      (0, _jquery.default)('.rooms ul li').last().addClass('active');
    }
  }

  function activateRoomControls() {
    var room = (0, _jquery.default)(this).data('id');
    (0, _jquery.default)('.rooms ul li').removeClass('active');
    (0, _jquery.default)(this).addClass('active');
    (0, _jquery.default)('.rooms-controls').removeClass('active');
    (0, _jquery.default)(".rooms-controls[data-id=".concat(room, "]")).addClass('active');
  }
});
},{"@fancyapps/ui":"../node_modules/@fancyapps/ui/dist/fancybox.esm.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
